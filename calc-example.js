...
/*     var shipping = document.querySelector('input[name=ship]:checked').value || ''; */            /* SI SE REQUIEREN CONDICIONALES CON RADIO BUTTONS */
...
/*     var special_gift = document.getElementById("gift").checked;
    ...
    var t_quantity = sneakers + jersey + supple + water;        /* esto calcula solo multiplier de cantidad */
    ...
    document.getElementById('total_estimate').value=estimate;
            ...
            /* SOLO SI ES QUE SE NECESITA VER UN DESGLOCE DE LA TRANSACCION */
